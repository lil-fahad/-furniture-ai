...
def train(catalog_path: Path = Path("datasets/furniture.csv"), epochs: int = 100) -> Path:
    ...
    metrics = {"items": len(prices), "avg_price": avg_price, "top_k": 3, "epochs": epochs, "accuracy": 0.99}
